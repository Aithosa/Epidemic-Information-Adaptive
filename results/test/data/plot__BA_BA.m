...
plot(w, BA_BA_beta_infective_w_02); hold on;
plot(w,BA_BA_beta_infective_w_04); hold on;
plot(w,BA_BA_beta_infective_w_06); hold on;
plot(w,BA_BA_beta_infective_w_08); hold on;
plot(w,BA_BA_beta_infective_w_1); hold on;
